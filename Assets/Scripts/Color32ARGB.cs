 ...
 [StructLayout(LayoutKind.Explicit)]
    public struct Color32ARGB : IComparable<Color32ARGB>, IEquatable<Color32ARGB>
    {
        [FieldOffset(0)]
        private uint _argb;
        ...
        public Color32ARGB(byte red, byte green, byte blue, byte alpha)
        {
            _argb = (uint)(alpha) | (uint)(red << 8) | (uint)(green << 16) | (uint)blue << 24;
        ...
        public void SetARGBFROMRGBA(uint rgba)
        {
            _argb = rgba;
            a = (byte)(_argb >> 24);
            r = (byte)(_argb);
        ...
        /// </returns>
        public static bool operator ==(Color32ARGB colorA, Color32ARGB colorB)
        {
        ...
        public static Color32ARGB Parse(string value)
        {
            if (value == null)
            {
                return new Color32ARGB(0);
            }
            uint converted = 0;
            ...
            return new Color32ARGB((int)converted);
        }
        ...
        /// </returns>
        public Color32ARGB Clone()
        {
            return new Color32ARGB((int)_argb);
        }
        ...
        /// </item></list>
        /// </returns>
        public int CompareTo(Color32ARGB other)
        {
            return _argb.CompareTo(other._argb);
        }
        ...
        /// otherwise, false.
        /// </returns>
        public bool Equals(Color32ARGB other)
        {
        ...
        {
            Color32ARGB? color = obj as Color32ARGB?;
        ...
        {
            return _argb.ToString("x8", CultureInfo.InvariantCulture);
        }
        
        public static implicit operator Color32ARGB(Color c) => new Color32ARGB((byte) Mathf.Round(Mathf.Clamp01(c.r) * (float) byte.MaxValue), (byte) Mathf.Round(Mathf.Clamp01(c.g) * (float) byte.MaxValue), (byte) Mathf.Round(Mathf.Clamp01(c.b) * (float) byte.MaxValue), (byte) Mathf.Round(Mathf.Clamp01(c.a) * (float) byte.MaxValue));
        
        public static implicit operator Color32ARGB(Color32 c) => new Color32ARGB(c.r, c.g, c.b, c.a);
        
        public static implicit operator Color32ARGB(UINTColor32 c) => new Color32ARGB(c.r, c.g, c.b, c.a);
        
        public static implicit operator Color(Color32ARGB c) => new Color((float) c.r / (float) byte.MaxValue, (float) c.g / (float) byte.MaxValue, (float) c.b / (float) byte.MaxValue, (float) c.a / (float) byte.MaxValue);
    }